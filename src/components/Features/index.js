...
const Features = () => {
  ...
  return (
    <Container maxW='150vw' bg='white' p='0'>
      <Container
        mt='2.5rem'
        maxW='150rem'
        p={{ base: '2rem', md: '5rem' }}
        ...
        <Container maxW='110rem' w='fit-content' bg='black' p='0' rounded='md'>
          ...
          >
            <VStack spacing={{ base: '4rem', md: '6rem' }}>
              ...
              <Flex
                gap='2.5rem'
                direction={widthLessThan1240 ? 'row' : 'column'}
              >
                ...
                <Center bg='black' rounded='lg' maxW='28rem' maxH='19rem'>
                  ...
                  >
                    ...
                    <Text
                      ...
                      fontSize={{ base: '12px', md: '16px' }}
                    >
                      We have thousands of ATMs located across the U.S. where
                      you can easily convert cash to crypto
                    </Text>
                  </VStack>
                </Center>
